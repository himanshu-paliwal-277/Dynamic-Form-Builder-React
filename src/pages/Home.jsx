    ...
    <>
        ...
        <div className='sm:px-[10%] px-[5%] pt-5 pb-8 flex flex-col gap-5 bg-gray-100 bg-opacity-50'>
          ...
          <div className='flex gap-3 sm:gap-5'>
            <div className=''>
              <div onClick={() => createForm()} className='border-[1px] border-gray-300 hover:border-purple-600  cursor-pointer flex items-center justify-center sm:h-40 h-28 mb-2 text-5xl bg-white rounded-lg w-32 sm:w-56 overflow-hidden'>
            ...
            <div className=''>
              <div onClick={() => createContactInfoForm()} className='overflow-hidden border-[1px] border-gray-300 hover:border-purple-600  cursor-pointer flex items-center justify-center sm:h-40 h-28 mb-2 text-5xl  rounded-lg sm:w-56 w-32 bg-green-100'>
                <div className='w-full px-3 pt-4 overflow-hidden h-28 sm:h-40 sm:px-7'>
                      <div className='sm:px-3 px-2 py-2  bg-white border-t-[6px] border-green-500 rounded-lg'>
                          <h1 className='mb-1 text-xs font-semibold sm:text-sm'>Contact Info</h1>
              ...
              <h3 className='text-md sm:text-lg'>Contact Info</h3>
            </div>
          </div>
        </div>
        <SavedForms />
